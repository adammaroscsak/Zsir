...
public abstract class Player {
    ...
    /**
     * Add the specified score to the score of player.
     *
     * @param score how many score to be added to the score of player
     */
    ...
    /**
     * Add the specified list of cards to the cards of player.
     *
     * @param cards list of cards to be added to the cards of player
     */
    ...
    /**
     * Removes and returns the choosed card.
     *
     * @return choosed card
     */
    public Card putCard() {
